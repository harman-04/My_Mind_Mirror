...
const EmotionRadarChart = ({ entries, isLoading }) => {
  ...
  if (chartData.length === 0 || chartData.every(d => d.intensity === 0)) {
    return (
      <div className="h-96 w-full flex flex-col items-center justify-center text-gray-500 dark:text-gray-400 space-y-4">
        ...
        <p className="text-lg font-medium">Not enough emotional data yet</p>
