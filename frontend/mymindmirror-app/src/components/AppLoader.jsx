...
//
// // 🌟 AESTHETIC & PERFORMANCE UPGRADE: Removed full-screen GPU-crashing blur, synced Enterprise Slate
//     const overlayBg = isDarkMode ? 'bg-[#0f0c29]/95' : 'bg-slate-50/95';
//     const cardBg = isDarkMode ? 'bg-[#131127] border-white/10' : 'bg-white border-slate-200/80';
//
//     return (
//         <div className={`fixed inset-0 flex items-center justify-center z-[200] ${overlayBg} transition-opacity duration-500`}>
//
//             {/* 🌟 SAFE: default 'transition' applied to the card to prevent layout lag, shadow optimized to shadow-xl */}
//             <div className={`p-8 lg:p-12 rounded-[2rem] lg:rounded-[2.5rem] ${cardBg} border shadow-xl flex flex-col items-center justify-center text-center max-w-[90%] sm:max-w-md mx-auto transform transition duration-500 ease-in-out`}>
//
...
//                     <div className="absolute inset-0 bg-purple-500/30 dark:bg-teal-500/30 rounded-full blur-2xl animate-pulse" />
//                     <Sparkles
//                         className="w-12 h-12 lg:w-16 lg:h-16 relative text-purple-600 dark:text-teal-400 animate-bounce drop-shadow-lg"
//                         style={{ animationDuration: '2.5s' }}
//                     />
//                 </div>
//
...
//
// {/* Indeterminate Sweeping Progress Bar */}
//                 {/* 🌟 AESTHETIC UPGRADE: Synced track background to contrast perfectly against the Slate/Dark cards */}
//                 <div className="w-48 lg:w-64 h-1.5 lg:h-2 bg-slate-100 dark:bg-white/5 rounded-full overflow-hidden relative shadow-inner border border-slate-200/60 dark:border-white/5">
//                     <div className="absolute top-0 left-0 h-full w-1/2 bg-gradient-to-r from-purple-500 to-teal-500 rounded-full animate-progress-indeterminate shadow-[0_0_10px_rgba(20,184,166,0.5)]" />
//                 </div>
//
